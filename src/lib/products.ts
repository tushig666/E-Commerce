...
export const staticProducts: Product[] = [
  ...
  },
  {
    ...
    description: 'Effortlessly chic, these wide-leg trousers are crafted from breathable linen, perfect for warmer days. They feature a high-rise waist and a relaxed, flowing silhouette.',
    price: 320,
    images: ['https://picsum.photos/seed/k1/900/1200', 'https://picsum.photos/seed/k2/900/1200'],
    category: 'Trousers',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    description: 'A modern take on classic tailoring, these trousers feature a sharp cropped length. Made from a structured twill, they have a slim fit and front crease for a polished look.',
    price: 350,
    images: ['https://picsum.photos/seed/l1/900/1200', 'https://picsum.photos/seed/l2/900/1200'],
    category: 'Trousers',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    description: 'Combining the look of a skirt with the comfort of trousers, these pleated culottes are a versatile wardrobe addition. Made from a lightweight crepe fabric, they move beautifully with every step.',
    price: 290,
    images: ['https://picsum.photos/seed/m1/900/1200', 'https://picsum.photos/seed/m2/900/1200'],
    category: 'Trousers',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
